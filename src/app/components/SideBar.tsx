...
export default function SideBar() {
  return (
    <div className="flex justify-between lg:flex-col bg-slate-700 lg:h-screen items-center lg:rounded-br-xl">
      <div className="p-7 bg-violet-500 rounded-br-xl">
      ...
      <div className="flex lg:flex-col items-center">
        <div className="p-6 fill-slate-300 mr-2 lg:mr-0">
        ...
        <div className="p-5 border-l lg:border-l-0 lg:border-t border-slate-500">
          <Image
